...
@section('content')
    <div class="page-wrap">
        ...
        <div class="form-side">
            ...
            <div class="tab-row">
                <button class="tab-btn active" onclick="window.location.href = '{{ route('user.login') }}'">Masuk</button>
                <button class="tab-btn" onclick="window.location.href = '{{ route('user.register') }}'">Daftar</button>
            </div>

            @session("success")
                <div id="success_info" class="w-full rounded-xl p-4 bg-gray-100/90 flex gap-3 items-center  mb-5 border-gray-200 border">
            ...
            <div id="panel-login" class="panel active">
                ...
                <form action="{{ route('user.login.store') }}" method="POST">
                    ...
                    <div class="field-group">
                        ...
                        <input class="field-input" required name="email" type="email"
                    ...
                    <div class="field-group">
                        ...
                        <input class="field-input" required name="password" type="password"
                            placeholder="Masukkan kata sandi" style="margin-top:7px" />
                        @error('password')
                            <span style="color:red; font-size:12px;">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="social-row">
                    <button class="btn-social" onclick="window.location.href='{{ route('user.auth.google') }}'">
            ...
            <div id="panel-register" class="panel">
                ...
                <div class="name-row">
                    <div class="field-group">
                        ...
                        <input class="field-input" required type="text" placeholder="Nama depan" />
                    </div>
                    <div class="field-group">
                        <label class="field-label">Nama belakang</label>
                        <input class="field-input" required type="text" placeholder="Nama belakang" />
                    </div>
                </div>

                <div class="field-group">
                    <label class="field-label">Alamat email</label>
                    <input class="field-input" required type="email" placeholder="Masukkan email Anda" />
                </div>

                <div class="field-group">
                    <label class="field-label">Kata sandi</label>
                    <input class="field-input" required type="password" placeholder="Buat kata sandi (min. 8 karakter)" />
                </div>

                <div class="field-group" style="margin-bottom:20px">
                    <label class="field-label">Konfirmasi kata sandi</label>
                    <input class="field-input" required type="password" placeholder="Ulangi kata sandi" />
                </div>
...
@section('scripts')
    ...
    <script>
        const infoSuccess = document.getElementById('success_info')
        if (infoSuccess) {
            setTimeout(() => {
