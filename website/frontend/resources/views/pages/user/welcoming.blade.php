...
<div class="lg:hidden w-full min-h-screen flex flex-col bg-[#f0f2f5]">
  ...
  <div class="relative w-full overflow-hidden bg-[]" style="min-height:120px">
    ...
    <div class="fade-up absolute top-5 right-5 z-20 w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center">
      <img src="{{ asset('assets/img/logo-round.png') }}" alt="">
  ...
  <div class="flex-1 px-6 py-6 flex flex-col gap-5">
    ...
    <div class="fade-up d1">
      ...
      <h1 class="text-[25px] font-black text-gray-900 leading-tight">
    ...
    <div class="fade-up d2 flex gap-3 overflow-x-auto pb-1" style="scrollbar-width:none">
      <div class="fc w-[180px] bg-white rounded-2xl p-4 border border-gray-100 flex-shrink-0">
    ...
    <div class="fade-up d4 mt-auto pt-2">
      <button onclick="window.location.href = '{{ route('user.dashboard.verify', Auth::user()->id) }}'" class="cta-pulse w-full bg-blue-600 text-white font-black text-lg py-4 rounded-2xl transition-all cursor-pointer">
        Mulai Sekarang
      </button>
...
<div class="hidden lg:flex w-full min-h-screen ">
  ...
  <div class="w-1/2 xl:w-[55%] relative bg-[#0d1117] justify-center flex flex-col overflow-hidden">
    <!-- Subtle radial glow -->
    ...
    <div class="fade-up relative z-10 flex items-center gap-3 p-8">
      <img src="{{ asset('assets/img/logo-round.png') }}" class="w-10" alt="">
    ...
    <div class=" flex items-center justify-center relative z-10 px-8">
    ...
    <div class="fade-up d2 absolute bottom-8 left-8 z-20 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-4 py-3 flex items-center gap-3">
    ...
    <div class="fade-up d3 absolute bottom-0 right-8 z-20 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-4 py-3 flex items-center gap-3">
  ...
  <!-- RIGHT: content panel -->
  <div class="w-1/2 xl:w-[45%] !h-screen bg-[#f0f2f5] overflow-auto flex flex-col justify-between px-12 xl:px-16 py-12">
    ...
    <div class="flex flex-col gap-7">
      ...
      <div class="fade-up d1">
        ...
        <h1 class="text-4xl xl:text-5xl font-black text-gray-900">
          Mulai Rasakan<br/>Pengalaman Parkir yang <span class="hl">Menarik</span>!
        </h1>
      </div>
      ...
      <!-- Partners -->
      <div class="fade-up d3 overflow-hidden lg:hidden">
    ...
    <div class="fade-up d4 mt-8 flex flex-col gap-3">
      <button onclick="window.location.href = '{{ route('user.dashboard.verify', Auth::user()->id) }}'" class="cta-pulse w-full bg-blue-600 text-white font-black text-xl py-5 rounded-2xl transition-all cursor-pointer">
        Mulai Sekarang
      </button>
