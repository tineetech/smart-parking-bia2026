...
<script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js"></script>
    <style>
        ...
        .tiket-card {
            ...
            overflow: hidden;
            animation: fade-up .45s cubic-bezier(.34, 1.20, .64, 1) both;
        }
        ...
        /* ── Tiket Header (biru) ── */
        .tiket-head {
            background: linear-gradient(135deg, var(--blue-main) 0%, #1d4ed8 100%);
        ...
        .tiket-tear-circle.left {
            margin-left: -10px;
        }

        .tiket-tear-circle.right {
            margin-right: -10px;
        }
        ...
        /* ══ DOWNLOAD BUTTON (fixed floating) ══ */
        .dl-btn-wrap {
            position: fixed;
...
@section('content')
    <div class="dl-loading" id="dl-loading">
        ...
        <div class="tiket-card" id="tiket-card">
            ...
            <div class="tiket-head">
                ...
                <div style="display:flex;align-items:center;gap:8px;margin-top:8px">
                    ...
                    @endif
                    @if ($pembayaran->status === 'aktif' || $pembayaran->status === 'running')
                        <div class="status-badge">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
                                <polyline points="22 4 12 14.01 9 11.01" />
...
@section('scripts')
    <script>
        ...
        function downloadTiket() {
            ...
            if (!qrCanvas) {
                alert('QR belum siap, coba sebentar lagi.');
                return;
            }
