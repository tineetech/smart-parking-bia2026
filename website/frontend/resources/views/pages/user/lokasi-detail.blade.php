...
<title>Parkify — {{ $lokasi->nama }}</title>
...
/* ── PAGE TOP BAR ── */
.page-topbar {
  max-width: 680px; margin: 0 auto; padding: 20px 24px 0;
...
.back-btn:hover { border-color: var(--border-focus); background: var(--bg-hover); }
.page-topbar-title { font-family: 'Space Grotesk', sans-serif; font-size: 18px; font-weight: 700; color: var(--text-primary); }

/* ── HERO IMAGE ── */
.hero-wrap { max-width: 680px; margin: 16px auto 0; padding: 0 24px; }
.hero-img {
  width: 100%; height: 220px; border-radius: 20px; overflow: hidden;
  position: relative; background: #1a2e4a;
}
...
.hero-status-badge.open  { background: rgba(16,185,129,0.92); }
.hero-status-badge.closed { background: rgba(239,68,68,0.88); }
.hero-status-dot { width: 6px; height: 6px; border-radius: 50%; background: #fff; }
.hero-status-badge.open .hero-status-dot { animation: pulse-dot 1.5s infinite; }
@keyframes pulse-dot { 0%,100%{opacity:1} 50%{opacity:0.4} }

/* ── LOKASI HEADER CARD ── */
.lokasi-header-card {
  background: var(--bg-card); border: 1px solid var(--border); border-radius: 20px;
  padding: 20px; margin-top: 16px; box-shadow: var(--shadow-sm);
}
.lokasi-name { font-family: 'Space Grotesk', sans-serif; font-size: 22px; font-weight: 800; color: var(--text-primary); letter-spacing: -0.4px; margin-bottom: 4px; }
.lokasi-type { font-size: 12.5px; color: var(--text-muted); font-weight: 500; margin-bottom: 14px; display: flex; align-items: center; gap: 5px; }
.lokasi-desc { font-size: 13px; color: var(--text-secondary); line-height: 1.75; }
...
.qs-card:hover { border-color: var(--border-focus); box-shadow: var(--shadow-md); }
.qs-icon { width: 34px; height: 34px; border-radius: 10px; display: flex; align-items: center; justify-content: center; margin: 0 auto 8px; }
.qs-value { font-family: 'Space Grotesk', sans-serif; font-size: 16px; font-weight: 800; line-height: 1; margin-bottom: 4px; }
.qs-label { font-size: 10.5px; color: var(--text-muted); font-weight: 500; }
...
/* ── INFO GROUP ── */
.info-group { background: var(--bg-card); border: 1px solid var(--border); border-radius: 18px; overflow: hidden; box-shadow: var(--shadow-sm); }
.info-row {
  display: flex; align-items: center; gap: 14px; padding: 14px 18px;
  border-bottom: 1px solid var(--border);
}
.info-row:last-child { border-bottom: none; }
.info-icon { width: 38px; height: 38px; border-radius: 11px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.info-body { flex: 1; min-width: 0; }
.info-label { font-size: 11.5px; color: var(--text-muted); font-weight: 500; margin-bottom: 2px; }
...
.info-action:hover { background: var(--blue-pale); }

/* ── SLOT GRID ── */
.slot-grid { display: grid; grid-template-columns: repeat(2,1fr); gap: 10px; }
.slot-card {
  background: var(--bg-card); border: 1px solid var(--border); border-radius: 16px;
  padding: 16px; box-shadow: var(--shadow-sm); transition: all 0.15s;
}
.slot-card:hover { border-color: var(--border-focus); box-shadow: var(--shadow-md); }
.slot-type { font-size: 11px; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; color: var(--text-muted); margin-bottom: 6px; }
.slot-count { font-family: 'Space Grotesk', sans-serif; font-size: 28px; font-weight: 800; line-height: 1; margin-bottom: 4px; }
.slot-avail { font-size: 11.5px; font-weight: 500; }
.slot-bar-wrap { margin-top: 10px; background: var(--border); border-radius: 999px; height: 5px; overflow: hidden; }
.slot-bar { height: 100%; border-radius: 999px; transition: width 0.5s ease; }

/* ── TARIF ── */
.tarif-group { background: var(--bg-card); border: 1px solid var(--border); border-radius: 18px; overflow: hidden; box-shadow: var(--shadow-sm); }
.tarif-row {
  display: flex; align-items: center; justify-content: space-between;
  padding: 14px 18px; border-bottom: 1px solid var(--border);
}
.tarif-row:last-child { border-bottom: none; }
.tarif-left { display: flex; align-items: center; gap: 11px; }
.tarif-icon { width: 36px; height: 36px; border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.tarif-name { font-size: 13.5px; font-weight: 600; color: var(--text-primary); }
.tarif-note { font-size: 11.5px; color: var(--text-muted); }
.tarif-price { font-family: 'Space Grotesk', sans-serif; font-size: 15px; font-weight: 800; color: var(--blue-main); }

/* ── MAP ── */
.map-placeholder {
  background: #e8f0f8; border: 1px solid var(--border); border-radius: 18px;
...
.map-placeholder:hover { border-color: var(--border-focus); }
.map-grid {
...
.map-pin {
  ...
  width: 32px; height: 32px; background: var(--blue-main);
...
.map-text-wrap { margin-top: 26px; z-index: 1; text-align: center; }
.map-placeholder-text { font-size: 13px; font-weight: 600; color: var(--text-secondary); }
.map-placeholder-sub { font-size: 11.5px; color: var(--text-muted); }
...
.btn-secondary {
  ...
  width: 100%; padding: 13px 24px; border-radius: 14px; margin-top: 10px;
  background: var(--bg-surface); border: 1.5px solid var(--border);
  color: var(--text-secondary); font-size: 13.5px; font-weight: 600;
  cursor: pointer; text-decoration: none; transition: all 0.15s;
}
.btn-secondary:hover { border-color: var(--border-focus); color: var(--blue-main); background: var(--blue-soft); }

/* ── TOAST (link copied) ── */
.toast {
  position: fixed; bottom: calc(var(--bottom-nav-h) + 20px + env(safe-area-inset-bottom));
...
@media (max-width: 400px) { .lokasi-name { font-size: 18px; } .slot-count { font-size: 22px; } }
</style>
</head>
<body>
...
<main class="main-wrap">
  ...
  <div class="page-topbar">
    ...
    <button class="icon-btn" onclick="copyUrl()" title="Salin tautan halaman ini" style="background:var(--bg-input);border:1px solid var(--border);">
  ...
  <div class="hero-wrap">
    <div class="hero-img">
      ...
      @else
        <div style="width:100%;height:100%;background:linear-gradient(135deg,#1e3a5f 0%,#2563eb 60%,#1d4ed8 100%);display:flex;align-items:center;justify-content:center;">
          <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.25)" stroke-width="1.5">
            <rect x="1" y="3" width="15" height="13" rx="2"/>
            <path d="M16 8h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4"/>
            <circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/>
          </svg>
  ...
  <div class="content-inner">
    ...
    <div class="lokasi-header-card">
      ...
      @else
        <div class="lokasi-desc" style="color:var(--text-muted);font-style:italic">Deskripsi belum tersedia.</div>
      @endif
    </div>
    ...
    <div class="quick-stats">
      <div class="qs-card">
        <div class="qs-icon" style="background:var(--blue-soft)">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--blue-main)" stroke-width="2">
            <rect x="1" y="3" width="15" height="13" rx="2"/>
            <path d="M16 8h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4"/>
            <circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/>
          </svg>
      ...
      <div class="info-group">
        ...
        <div class="info-row">
          <div class="info-icon" style="background:var(--blue-soft)">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--blue-main)" stroke-width="2">
              <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/>
              <circle cx="12" cy="9" r="2.5"/>
            </svg>
          </div>
          ...
          <a href="https://maps.google.com/?q={{ $lokasi->latitude }},{{ $lokasi->longitude }}" target="_blank" class="info-action">Peta</a>
        </div>

        {{-- Jam Operasional --}}
        <div class="info-row">
          <div class="info-icon" style="background:var(--green-soft)">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="2">
          ...
          <div class="info-body">
            ...
            <div class="info-value">
              Setiap hari, {{ \Carbon\Carbon::createFromTimeString($lokasi->jam_buka)->format('H.i') }} – {{ \Carbon\Carbon::createFromTimeString($lokasi->jam_tutup)->format('H.i') }} WIB
            </div>
          </div>
          @if($lokasi->aktif)
        ...
        <div class="info-row">
          <div class="info-icon" style="background:var(--amber-soft)">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--amber)" stroke-width="2">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 11.1a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8 9.91a16 16 0 0 0 6 6l.86-.86a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
            </svg>
          </div>
          <div class="info-body">
    ...
    <div style="margin-top:22px">
      ...
      <a href="https://maps.google.com/?q={{ $lokasi->latitude }},{{ $lokasi->longitude }}" target="_blank" class="map-placeholder">
